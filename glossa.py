...
if page == "Text to Text translation":
	...
	if st.button('Chat!'):
		...
		if query == "":
			...
			authoringKey = "4c8fdbfbc829480ab6fc6d92a7316347"
			...
			with st.spinner('Fetching Response...'):
				...
				predictionResponse = clientRuntime.prediction.get_slot_prediction("ba59277c-aa64-4a7b-b3d6-f5edb66d5184", "Production", predictionRequest)
				detected_intent = predictionResponse.prediction.top_intent
			#st.write(detected_intent)
